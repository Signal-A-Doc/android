...
public class AvailabilityMode implements Parcelable {
    ...
    public final static Parcelable.Creator<AvailabilityMode> CREATOR = new Creator<AvailabilityMode>() {


        @SuppressWarnings({
                "unchecked"
        })
        public AvailabilityMode createFromParcel(Parcel in) {
            return new AvailabilityMode(in);
        }

        public AvailabilityMode[] newArray(int size) {
            return (new AvailabilityMode[size]);
        }

    };

    protected AvailabilityMode(Parcel in) {
