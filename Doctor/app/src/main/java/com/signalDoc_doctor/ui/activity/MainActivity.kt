...
import com.signalDoc_doctor.ui.adapter.DrawerAdapter
...
import com.signalDoc_doctor.ui.fragment.doctor.*
...
class MainActivity : BaseActivity(), BaseActivity.PermCallback, BottomNavigationView.OnNavigationItemSelectedListener {
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.homeM -> {
                replaceFragment(HomeDoctorFragment(), R.id.frame_container)

            }
            R.id.appointmentsM -> {
                replaceFragment(AppointmentFragment(), R.id.frame_container)
    ...
    fun gotoHomeFragment() {
        ...
        supportFragmentManager.beginTransaction().replace(R.id.frame_container, HomeDoctorFragment()).commit()
    ...
    fun setToolbar(showIcon: Boolean, title: String) {
    ...
    fun setBottomNavigation(boolean: Boolean) {
        if (boolean == true) {
    ...
    override fun onClick(v: View) {
        when (v.id) {
            R.id.profilePicCIV, R.id.viewTV, R.id.nameTV -> {
                gotoAccountScreen()
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        if (fragment is BankDetailAccountFragment || fragment is HomeDoctorFragment) {
    ...
    override fun onBackPressed() {
        val fragment = supportFragmentManager.findFragmentById(R.id.frame_container)
        if (fragment is HomeDoctorFragment || fragment is BankDetailFragment) {
            backAction()
