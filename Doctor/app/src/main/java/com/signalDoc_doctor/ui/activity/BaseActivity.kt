...
package com.signalDoc_doctor.ui.activity
...
import com.signalDoc_doctor.ui.snackBar.ActionClickListener
import com.signalDoc_doctor.ui.snackBar.Snackbar
import com.signalDoc_doctor.ui.snackBar.SnackbarManager
import com.signalDoc_doctor.ui.snackBar.SnackbarType
import com.signalDoc_doctor.utils.*
...
open class BaseActivity : AppCompatActivity(), SyncEventListener, View.OnClickListener {
    ...
    private fun showNoNetworkDialog(status: String?) {
        ...
        SnackbarManager.create(
                Snackbar.with(this)
                        ...
                        .text(status!!).duration(com.signalDoc_doctor.ui.snackBar.Snackbar
                                .SnackbarDuration.LENGTH_INDEFINITE)
                        .actionLabel(getString(R.string.retry_caps))
                        .actionListener(object : ActionClickListener {
                            override fun onActionClicked(snackbar: com.signalDoc_doctor.ui.snackBar.Snackbar) {
    ...
    fun loadImage(baseActivity: BaseActivity, profileFile: String, errorImage: Int, imageView: CircleImageView) {
        try {
    ...
    fun loadRoundImage(baseActivity: BaseActivity, profileFile: String, errorImage: Int, imageView: RoundedImageView) {
        try {
            Glide.with(baseActivity).load(profileFile).apply(RequestOptions().placeholder(errorImage).error(errorImage)).into(imageView)
    ...
    fun showErrorToast(msg: String) {
        ...
        val titleTV = view.findViewById(R.id.errorToastTV) as TextView
    ...
    fun backAction() {
        if (exit) {
            ...
            showErrorToast(getString(R.string.press_one_more_time))
            exit = true
    ...
    fun convertDateIntoUTC(myDate: Date, targetDateFormat: String): String {
        val calendar = Calendar.getInstance()
        calendar.timeZone = TimeZone.getTimeZone("UTC")
        calendar.time = myDate
        val time = calendar.time
        val outputFmt = SimpleDateFormat(targetDateFormat)
