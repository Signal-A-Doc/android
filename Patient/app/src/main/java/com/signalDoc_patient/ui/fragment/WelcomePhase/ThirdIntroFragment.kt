...
import com.signalDoc_patient.databinding.FragmentWelcomeThreeBinding
...
class ThirdIntroFragment : BaseFragment(), ClickHandler {
    private var binding: FragmentWelcomeThreeBinding? = null
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        (baseActivity as LoginSignUpActivity).setToolbar(false)
        if (binding == null) {
            binding = DataBindingUtil.inflate(inflater, R.layout.fragment_welcome_three, container, false)
        }
        return binding!!.root
    }
